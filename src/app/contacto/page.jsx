  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-850">
      <div className="bg-gray-800 p-8 rounded shadow-lg w-full max-w-md">
        <h1 className="text-2xl font-bold mb-4 text-center text-gray-100">{t.contact || "Contacto"}</h1>
        {error && (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block mb-2 text-gray-300">{t.subject || "Tema"}:</label>
            <input
              type="text"
              value={tema}
          ...
          <div>
            <label className="block mb-2 text-gray-300">{t.description || "Descripción"}:</label>
            <textarea
              value={descripcion}
